...
| [`builtin.tests.pub-fn-untested`](/sextant-mcp/rules/builtin/tests-pub-fn-untested/) | info | rust, ts/tsx/js | Public function or exported declaration never mentioned in a test, in-file or in a conventional peer test file. |
